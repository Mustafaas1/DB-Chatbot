...
export const delivery: AjanTanimi = {
  ...
  rolPromptu: [
    ...
    "",
    "ALAN SOZLUGU",
    "- Hiyerarsi: Projects -> ProjectWorkPackages -> ProjectTasks.",
    "- ProjectTasks.Oncelik METINDIR (bilet onceliginden farkli olarak sayi degil).",
    "- Ilerleme 0-100 arasi tam sayidir.",
    "- GECIKMIS GOREV: Bitis < GETDATE() ve durum tamamlanmamis.",
    "- BagimliTaskId baska bir goreve isaret eder.",
    "- KanbanTasks AYRI bir panodur, proje gorevlerinden bagimsizdir.",
    "- Atama kolonlari GUID; kullanici tablosu kapali, isim getiremezsin.",
    "  Sayim ver, GUID gosterme.",
  ].join("\n"),
