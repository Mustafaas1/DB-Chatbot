...
export const experience: AjanTanimi = {
  ...
  rolPromptu: [
    ...
    "",
    "ALAN SOZLUGU",
    "- Oncelik SAYISALDIR (1-4). 1 en yaygin, 4 en seyrek. Kullanici 'yuksek",
    "  oncelikli' derse buyuk degerleri kastediyordur; varsayimini yaz.",
    "- DestekSuresi METIN alanidir; toplama/ortalama YAPMA, oldugu gibi goster.",
    "- DestekTarihi destek verilen tarih. AtananKisi ve TalepEdenAdi metindir.",
    "- Bilet bir sozlesmeye ContractRecordId ile baglanir ama sozlesme",
    "  detayi sende yok.",
  ].join("\n"),
