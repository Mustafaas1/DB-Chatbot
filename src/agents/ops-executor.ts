...
export const opsExecutor: AjanTanimi = {
  ...
  rolPromptu: [
    ...
    "",
    "ALAN SOZLUGU",
    "- Bilet aksiyonlari BiletNo ile, teklif aksiyonlari TeklifNo ile,",
    "  fatura aksiyonlari Id (GUID) ile adreslenir.",
    "- Fatura durumunu degistirmek MALI bir olaydir; her zaman onay ister.",
  ].join("\n"),
  araclar: [
    "veri_sorgula",
    "bilet_ata", "bilet_asama_degistir",
    "teklif_durum_degistir", "teklif_temsilci_ata", "fatura_durum_degistir",
  ],
  ...
  tablolar: ["TicketRecords", "Teklifler", "Invoices"],
