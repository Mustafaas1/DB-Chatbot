...
export const productPricing: AjanTanimi = {
  ...
  rolPromptu: [
    ...
    "",
    "ALAN SOZLUGU",
    "- Kalem tutari: TeklifKalemleri/InvoiceKalemleri'nde BirimFiyat x Miktar,",
    "  indirim IskontoOrani/IskontoTuru ile uygulanir.",
    "- Products: SatisFiyati satis, AlisFiyati alis, Maliyet maliyet.",
    "  Kategori/Marka/Tur urun kirilimlaridir.",
    "- CustomerProducts musterinin sahip oldugu urunlerdir; BaslamaTarihi-BitisTarihi",
    "  lisans donemi, LisansTipi lisans turudur.",
